...
export default class RNVoipPushNotification {
    ...
    static wakeupByPush = (Platform.OS == 'ios' && RNVoipCall.wakeupByPush === 'true');
    ...
    static presentLocalNotification(details) {
        RNVoipCall.presentLocalNotification(details);
    }
    ...
    static addEventListener(type, handler) {
        invariant(
            ...
            'RNVoipCall only supports `notification`, `register` and `localNotification` events'
        );
        var listener;
    ...
    static requestPermissions(permissions) {
        ...
        RNVoipCall.requestPermissions(requestedPermissions);
    }
     ...
     * If you want to use this function, make sure you call `[RNVoipCall addCompletionHandler:uuid completionHandler:completion];`
    ...
    static onVoipNotificationCompleted(uuid) {
        RNVoipCall.onVoipNotificationCompleted(uuid);
    }
