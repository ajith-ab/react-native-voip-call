...
const eventEmitter = new NativeEventEmitter(RNVoipCall);
...
const log = (data) => console.log('NVoipCall ==>' , data);
...
class RNVoipCallNativeModule {
    ...
    rejectCall = (uuid) => {
      ...
      endCall = (uuid) => IsIOS ?  RNVoipCall.endCall(uuid) : null;
    
      endAllCalls = () => IsIOS ?   RNVoipCall.endAllCalls() : null;
